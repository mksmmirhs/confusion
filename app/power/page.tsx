...
const PILLARS = [
  ...
  },
  {
    ...
    how: 'These 3 asset managers collectively own 15-20% of EVERY major defense contractor AND every major oil company. When wars increase contractor revenues, their managed funds grow. They fund Senate campaigns through financial industry PACs and ensure deregulatory senators chair Banking committees.',
    quote: '"BlackRock is the shadow government." — Analysts who tracked Larry Fink\'s role advising four consecutive Treasury Departments',
    stats: [
      { val: '$22T', label: 'Combined Assets Under Management' },
      { val: '15-20%', label: 'Stake in Every Major Defense Co.' },
      { val: '$480M', label: 'Finance Sector Senate Donations/Cycle' },
      { val: '3', label: 'Firms Control Most Proxy Votes in Fortune 500' },
    ],
    evidence: [
      'BlackRock hired multiple Obama Treasury officials (Michael Froman, etc.) immediately after they left government',
      'Larry Fink (BlackRock CEO) co-authored 2008 bailout advice while BlackRock was hired to manage the toxic assets',
      'State Street, Vanguard, BlackRock vote together in virtually all shareholder votes — forming an unprecedented concentration of power',
      'Dave McCormick: Bridgewater CEO → Republican Senate seat → Armed Services Committee (2025)',
    ],
  },
  {
    id: '03',
